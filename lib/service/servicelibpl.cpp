	...
	m_pump(eApp, 1)
{
	...
	|| (!strncmp("icecast://", m_ref.path.c_str(), 10))
	|| (!strncmp("librtmp://", m_ref.path.c_str(), 10))
	|| (!strncmp("librtmpe://", m_ref.path.c_str(), 11))
	|| (!strncmp("librtmps://", m_ref.path.c_str(), 11))
	|| (!strncmp("librtmpt://", m_ref.path.c_str(), 11))
