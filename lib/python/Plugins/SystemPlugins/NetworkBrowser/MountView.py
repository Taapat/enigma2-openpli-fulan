...
class AutoMountView(Screen):
        skin = """
                <screen name="AutoMountView" position="center,center" size="560,350" title="MountView">
                        ...
                        <widget source="key_yellow" render="Label" position="420,0" zPosition="1" size="140,40" font="Regular;16" halign="center" valign="center" backgroundColor="#a08500" transparent="1" />
                        <widget source="legend1" render="Label" position="0,50" zPosition="1" size="130,40" font="Regular;16" halign="center" valign="center" backgroundColor="#25062748" transparent="1" />
                        <widget source="legend2" render="Label" position="130,50" zPosition="1" size="310,40" font="Regular;16" halign="center" valign="center" backgroundColor="#25062748" transparent="1" />
                        <widget source="legend3" render="Label" position="410,50" zPosition="1" size="100,40" font="Regular;16" halign="center" valign="center" backgroundColor="#25062748" transparent="1" />
                        ...
                        <widget source="introduction" render="Label" position="110,320" size="300,20" zPosition="10" font="Regular;18" halign="center" valign="center" backgroundColor="#25062748" transparent="1" />
                </screen>"""
