...
from os import path as os_path, stat, mkdir, remove, system
		...
		<screen name="NetworkBrowser" position="center,center" size="560,450" title="Network Neighbourhood">
			...
			<widget source="list" render="Listbox" position="5,50" size="540,350" zPosition="10" scrollbarMode="showOnDemand">
				<convert type="TemplatedMultiContent">
					...
					"fonts": [gFont("Regular", 18),gFont("Regular", 14),gFont("Regular", 20)],
					"itemHeight": 50
					}
				</convert>
			</widget>
			<ePixmap pixmap="skin_default/div-h.png" position="0,410" zPosition="1" size="560,2" />		
			<widget source="infotext" render="Label" position="0,420" size="560,30" zPosition="10" font="Regular;18" halign="center" valign="center" backgroundColor="#25062748" transparent="1" />
		</screen>"""
